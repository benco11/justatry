...
var format = require('../../../util/javascript-number-formatter.js');
    ...
    return {
        ...
        link: function (scope, element, attrs, ctrl) {
            ...
            function parser(value, isFromProgrammaticCall) {
                ...
                var convertedValue = ('' + modelValue).replace(replacementRegex, '');
            ...
            function formatter(value) {
                ...
                var convertedValue = ('' + value).replace(replacementRegex, '');
                if (isNaN(convertedValue)) {
                    return value;
                }
            ...
            $(element).on('focus', function() {
                ...
                try {
                    if (ctrl.$valid) {
                        ...
                        var convertedValue = ('' + ctrl.$modelValue).replace(replacementRegex, '');
                        if (isNaN(convertedValue)) {
                            return;
                        }
